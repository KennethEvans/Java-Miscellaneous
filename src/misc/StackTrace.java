...
//Java core packages:
/**
 ** Using the new Java v1.4 facilities in the Throwable class to pull information
 * out of a stack trace. <br>
 * <br>
 ** 
...
public class StackTrace
{
  ...
  public static boolean displayStackTraceInformation(Throwable ex,
    ...
    if(displayAll) {
      ...
      System.out.println("The top element of a " + stackElements.length
        + " element stack trace:\n");
    }
    ...
    for(int lcv = 0; lcv < stackElements.length; lcv++) {
      ...
      System.out.println("Package name: "
        + ("".equals(packageName) ? "[default package]" : packageName));
