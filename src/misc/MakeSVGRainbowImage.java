...
{
    private static final int NCOLORS = 16;
    private static int nColors = NCOLORS;

    private static final String[] PRE = {"<svg>",
        "    <linearGradient id=\"Rainbow Colors\" gradientUnits=\"objectBoundingBox\" spreadMethod=\"pad\" >",
    ...
    private static final String[] POST = {"      </linearGradient>", "</svg>",
